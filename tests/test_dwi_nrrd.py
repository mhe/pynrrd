...
test_dwi_nrrd.py
================
This program is designed to test the functionality of "dwi_nrrd" in dealing with DWI meta data.
...
THIRD, use pynrrd (nrrd.py, dwi_nrrd.py) to read the input DWI scan provided in Nrrd format.
...
(i.e. average close gradients) and write the average Nrrd file to the disk using dwi_nrrd.

Usage:
test_dwi_nrrd.py --inputDWIScan DWISCAN --outputDir OUTPUTDIR --program_path PROGRAM_PATH
...
from dwi_nrrd import ReadNAMICDWIFromNrrd,WriteNAMICDWIToNrrd
...
if __name__ == '__main__':
  ...
  #THIRD use nrrd.py + dwi_nrrd.py to read input Nrrd DWI data
