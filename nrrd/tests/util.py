...
RAW_BYTESKIP_NHDR_FILE_PATH = os.path.join(
    DATA_DIR_PATH, "BallBinary30x30x30_byteskip_minus_one.nhdr"
)
GZ_BYTESKIP_NIFTI_NHDR_FILE_PATH = os.path.join(
    DATA_DIR_PATH, "BallBinary30x30x30_byteskip_minus_one_nifti.nhdr"
)
GZ_NIFTI_NHDR_FILE_PATH = os.path.join(DATA_DIR_PATH, "BallBinary30x30x30_nifti.nhdr")
RAW_INVALID_BYTESKIP_NHDR_FILE_PATH = os.path.join(
    DATA_DIR_PATH, "BallBinary30x30x30_byteskip_minus_five.nhdr"
)
...
GZ_LINESKIP_NRRD_FILE_PATH = os.path.join(
    DATA_DIR_PATH, "BallBinary30x30x30_gz_lineskip.nrrd"
)
GZ_BYTESKIP_NRRD_FILE_PATH = os.path.join(
    DATA_DIR_PATH, "BallBinary30x30x30_gz_byteskip_minus_one.nrrd"
)
