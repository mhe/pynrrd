...
def _handle_header(data, header=None, index_order: IndexOrder = 'F'):
    if header is None:
        header = {}
...
def _write_header(file, header, custom_field_map: Optional[Dict[str, NRRDFieldType]] = None):
...
def _write_data(data, fh, header, compression_level: Optional[int] = None, index_order: IndexOrder = 'F'):
...
def write(file, data, header=None, detached_header: bool = False, relative_data_path: bool = True,
          custom_field_map: Optional[Dict[str, NRRDFieldType]] = None, compression_level: int = 9,
